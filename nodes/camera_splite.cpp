...
int main(int argc, char** argv)
{
  ...
  nh.param("camera_info_url_left", camera_info_url_left, std::string("file:///home/ros/stereo_calib3/left.yaml"));//加载左相机的参数
  nh.param("camera_name_right", camera_name_right, std::string("camera_R"));
  nh.param("camera_info_url_right", camera_info_url_right, std::string("file:///home/ros/stereo_calib3/right.yaml"));
